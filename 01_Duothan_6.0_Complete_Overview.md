...
- IEEE Computer Society Chapter (NSBM)
...
- ❌ Loan systems — **NON-FUNCTIONAL**
- ❌ Millions lost access to essential financial services
- ❌ Small businesses can't process digital transactions
- ❌ People forced to rely entirely on cash
...
- Feature **independent services (microservices)** architecture
- Include a strong **disaster recovery plan**
- Ensure an attack like this **can never happen again**
...
1. **Original Work Only** — All work must be original and developed during the competition period
2. **No Pre-built Solutions** — Cannot use code not developed during the competition
3. **Strict Deadlines** — Late submissions are **NOT accepted**
4. **Zero Plagiarism Tolerance** — Copying = immediate disqualification
5. **Don't Share** — Never share challenge materials or your solution with other teams
6. **Data Backup** — YOU are responsible for backing up your files (organizers are not liable for data loss)
7. **Follow Guidelines** — Solutions must align with the context documents and evaluation criteria
8. **Code of Conduct** — Respect judges, mentors, organizers, and fellow participants
...
- [ ] Portable power bank
- [ ] Phase 2 development web application
...
1. This is **NOT just a coding competition** — it's a full DevOps lifecycle challenge
2. You need skills in **planning, architecture, development, deployment, and security**
3. The theme is **rebuilding a banking system** after a cyber attack
4. **Microservices architecture** is mandatory (independent services)
5. You need a **cloud account** (AWS/GCP/Azure)
6. Phase 1 is a **design/planning phase** — no coding yet!
7. Each phase is **eliminatory** — you must pass to proceed
